...
$GLOBALS['TL_DCA']['tl_ytvideo'] = array
    ...
    'fields' => array
        ...
        'width' => array
            ...
            'sql' => "int(10) NOT NULL default '480'"
        ),
        'height' => array
            (
            ...
            'exclude' => true,
            'eval' => array('mandatory' => false, 'rgxp' => 'digit', 'tl_class' => 'w50'),
            'sql' => "int(10) NOT NULL default '360'"
        ),
        'autohide' => array
            (
            ...
            'sql' => "tinyint(1) unsigned NOT NULL default '2'"
        ),
        'controls' => array
            (
        ...
        'color' => array
            ...
            'exclude' => true,
            'eval' => array('mandatory' => false, 'tl_class' => 'w50'),
            'sql' => "varchar(5) NOT NULL default 'red'"
        ),
        'theme' => array
            (
            ...
            'exclude' => true,
            'eval' => array('mandatory' => false, 'tl_class' => 'w50'),
            'sql' => "varchar(5) NOT NULL default 'dark'"
        ),
        'showinfo' => array
            (
